  ...
  if (toggleBtn && content && arrow) {
    toggleBtn.addEventListener('click', () => {
      ...
      if (isCollapsed) {
        ...
        // unreachable any row past that height — which is exactly what
...
function updateTheme(theme) {
  ...
  // can no longer drift out of sync with the sidebar's quick-toggle
  // buttons, which also call window.setTheme() directly.
  if (window.setTheme) {
